"""CLI for aggregate causal evidence in one partial manifest checkpoint."""
...
def parser() -> argparse.ArgumentParser:
    value = argparse.ArgumentParser(
        description="Inventory stored causal evidence in one partial checkpoint."
    )
...
def main(
    ...
    *,
    ...
    try:
        ...
        payload = ManifestPartialCausalInventoryDiagnostic(
            clock=runtime_clock
